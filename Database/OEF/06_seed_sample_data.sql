...
INSERT INTO raw.account (account_no, customer_code, broker_code, open_date) VALUES
    ('0003000001', 'KH00001', 'MG001', '2022-05-01');
...
INSERT INTO raw.account_balance_daily (balance_date, account_id, cash_balance, portfolio_value, total_asset_value) VALUES
    ('2026-07-17', 1, 0, 10000000, 10000000);

INSERT INTO raw.position_daily (position_date, account_id, fund_id, quantity_unit, avg_cost_nav, market_value) VALUES
    ('2026-07-17', 1, 1, 350.8772, 28500.00, 10000000);
