-- SSI_Equity: equity (co so) trading data - instrument master, trades, accounts/positions.
-- Raw/source layer: mirror tu he thong core trading, chua qua ETL/transform.
