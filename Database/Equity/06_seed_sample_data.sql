...
INSERT INTO raw.account (account_no, customer_code, broker_code, open_date) VALUES
    ('0001000001', 'KH00001', 'MG001', '2022-05-01'),
    ('0001000002', 'KH00002', 'MG002', '2022-08-15');
...
INSERT INTO raw.account_balance_daily (balance_date, account_id, cash_balance, portfolio_value, total_asset_value) VALUES
    ('2026-07-17', 1, 50000000, 32500000, 82500000),
    ('2026-07-17', 2, 20000000, 34000000, 54000000);

INSERT INTO raw.position_daily (position_date, account_id, security_id, quantity, avg_cost_price, market_value) VALUES
    ('2026-07-17', 1, 1, 1000, 32.50, 32500000);
