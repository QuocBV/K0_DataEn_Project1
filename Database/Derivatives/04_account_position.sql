...
--
-- Derivatives-specific dimension/logical reference: this DB no longer owns account data.
...
CREATE TABLE raw.position_daily (
    ...
    CONSTRAINT pk_position_daily PRIMARY KEY CLUSTERED (account_no, contract_id, position_date),
