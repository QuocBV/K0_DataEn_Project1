...
INSERT INTO raw.account (account_no, customer_code, broker_code, open_date) VALUES
    ('0002000001', 'KH00002', 'MG002', '2022-08-15');
...
INSERT INTO raw.account_balance_daily (balance_date, account_id, cash_balance, portfolio_value, total_asset_value) VALUES
    ('2026-07-17', 1, 100000000, 0, 100000000);

INSERT INTO raw.position_daily (position_date, account_id, contract_id, position_side, quantity, avg_cost_price, market_value) VALUES
    ('2026-07-17', 1, 1, 'LONG', 2, 1330.50, 266100000);

INSERT INTO raw.margin_loan_daily (loan_date, account_id, margin_loan_balance, margin_ratio, maintenance_margin_ratio, call_margin_flag) VALUES
    ('2026-07-17', 1, 26610000, 0.18, 0.15, 0);
