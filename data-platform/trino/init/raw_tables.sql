...
-- Matches Airbyte S3 layout: s3a://quocbv-fraud-data/raw/SSI_Common/... etc.
-- Run inside trino: trino --execute @file.sql

CREATE SCHEMA IF NOT EXISTS ssi_raw."SSI_Common" WITH (location = 's3a://quocbv-fraud-data/raw/SSI_Common/');
CREATE SCHEMA IF NOT EXISTS ssi_raw."SSI_Equity" WITH (location = 's3a://quocbv-fraud-data/raw/SSI_Equity/');
CREATE SCHEMA IF NOT EXISTS ssi_raw."SSI_Derivatives" WITH (location = 's3a://quocbv-fraud-data/raw/SSI_Derivatives/');
CREATE SCHEMA IF NOT EXISTS ssi_raw."SSI_OEF" WITH (location = 's3a://quocbv-fraud-data/raw/SSI_OEF/');

-- ============ SSI_Common ============
CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Common".account (
...
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Common/account/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Common".branch (
    ...
    source_updated_at timestamp(3), ingested_at timestamp(3),
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Common/branch/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Common".broker (
    ...
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Common/broker/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Common".customer (
    ...
    source_system varchar, source_updated_at timestamp(3), ingested_at timestamp(3),
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Common/customer/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Common".customer_broker_history (
    ...
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Common/customer_broker_history/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Common".customer_risk_profile (
    ...
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Common/customer_risk_profile/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Common".customer_segment_history (
    history_id bigint, customer_code varchar, segment varchar, valid_from timestamp(3),
    valid_to timestamp(3), is_current boolean, source_system varchar, ingested_at timestamp(3),
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Common/customer_segment_history/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Common".customer_acquisition (
    ...
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Common/customer_acquisition/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Common".fee_schedule (
    ...
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Common/fee_schedule/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Common".management_commission_schedule (
    ...
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Common/management_commission_schedule/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Common".market_index_price (
    ...
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Common/market_index_price/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Common".trading_alert (
    ...
    source_system varchar, ingested_at timestamp(3),
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Common/trading_alert/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Common".customer_complaint (
    ...
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Common/customer_complaint/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Common".employees (
    ...
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Common/employees/', format = 'PARQUET');

-- ============ SSI_Equity ============
CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Equity".security (
    ...
    source_updated_at timestamp(3), ingested_at timestamp(3),
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Equity/security/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Equity".daily_price (
    ...
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Equity/daily_price/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Equity".equity_trade (
    ...
    source_updated_at timestamp(3), ingested_at timestamp(3),
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Equity/equity_trade/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Equity".account_balance_daily (
    ...
    ingested_at timestamp(3),
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Equity/account_balance_daily/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Equity".position_daily (
    ...
    ingested_at timestamp(3),
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Equity/position_daily/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Equity".margin_loan_daily (
    ...
    source_system varchar, ingested_at timestamp(3),
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Equity/margin_loan_daily/', format = 'PARQUET');

-- ============ SSI_Derivatives ============
CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Derivatives".derivative_contract (
    ...
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Derivatives/derivative_contract/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Derivatives".daily_settlement_price (
    ...
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Derivatives/daily_settlement_price/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Derivatives".derivative_trade (
    trade_id bigint, trade_date timestamp(3), trade_datetime timestamp(3),
    source_trade_id varchar, account_no varchar, customer_code varchar, broker_code varchar,
    ...
    source_updated_at timestamp(3), ingested_at timestamp(3),
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Derivatives/derivative_trade/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Derivatives".account_balance_daily (
    balance_date timestamp(3), account_no varchar, cash_balance decimal(38,8),
    portfolio_value decimal(38,8), total_asset_value decimal(38,8), source_system varchar,
    ingested_at timestamp(3),
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Derivatives/account_balance_daily/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Derivatives".position_daily (
    ...
    source_system varchar, ingested_at timestamp(3),
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Derivatives/position_daily/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_Derivatives".margin_loan_daily (
    loan_date timestamp(3), account_no varchar, margin_loan_balance decimal(38,8),
    margin_ratio decimal(38,8), maintenance_margin_ratio decimal(38,8), call_margin_flag boolean,
    source_system varchar, ingested_at timestamp(3),
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_Derivatives/margin_loan_daily/', format = 'PARQUET');

-- ============ SSI_OEF ============
CREATE TABLE IF NOT EXISTS ssi_raw."SSI_OEF".fund (
    ...
    source_updated_at timestamp(3), ingested_at timestamp(3),
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_OEF/fund/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_OEF".fund_nav_history (
    ...
    ingested_at timestamp(3),
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_OEF/fund_nav_history/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_OEF".oef_trade (
    trade_id bigint, trade_date timestamp(3), trade_datetime timestamp(3),
    source_trade_id varchar, account_no varchar, customer_code varchar, broker_code varchar,
    ...
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_OEF/oef_trade/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_OEF".account_balance_daily (
    balance_date timestamp(3), account_no varchar, cash_balance decimal(38,8),
    portfolio_value decimal(38,8), total_asset_value decimal(38,8), source_system varchar,
    ingested_at timestamp(3),
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_OEF/account_balance_daily/', format = 'PARQUET');

CREATE TABLE IF NOT EXISTS ssi_raw."SSI_OEF".position_daily (
    ...
    ingested_at timestamp(3),
    _airbyte_ab_id varchar, _airbyte_emitted_at timestamp(3), _airbyte_raw_id varchar, _airbyte_data json)
WITH (external_location = 's3a://quocbv-fraud-data/raw/SSI_OEF/position_daily/', format = 'PARQUET');